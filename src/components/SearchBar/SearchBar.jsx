export default function SearchBar({ onHandleSubmit, onSetSearchInput, onSearchInput }) {
    return (
        <>
            {/* Search bar for resources */}
            <div className='d-flex justify-content-center p-4 animate__animated animate__fadeIn'>
